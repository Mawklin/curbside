// Draws the Curbside icon (a price tag with a sparkle) and writes the PNG sizes the app needs.
...
const art = (scale, rounded) => `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  <defs>
    <linearGradient id="bg" x1="0" y1="0" x2="0.4" y2="1">
      <stop offset="0" stop-color="#3a8463"/><stop offset="1" stop-color="#22533d"/>
    </linearGradient>
    <linearGradient id="tag" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0" stop-color="#fffaf0"/><stop offset="1" stop-color="#efe5d1"/>
    </linearGradient>
  </defs>
  ...
  <g transform="translate(256 262) scale(${scale}) rotate(-32)">
    <path d="M-168 0 L-98 -86 H118 Q148 -86 148 -56 V56 Q148 86 118 86 H-98 Z"
      fill="#173d2c" opacity="0.28" transform="translate(10 14)"/>
    <path d="M-168 0 L-98 -86 H118 Q148 -86 148 -56 V56 Q148 86 118 86 H-98 Z"
      fill="url(#tag)" stroke="#fffaf0" stroke-width="18" stroke-linejoin="round"/>
    <circle cx="-92" cy="0" r="21" fill="#2d6a4f"/>
    <path d="M-10 -34 H92 M-10 0 H70 M-10 34 H92" stroke="#2d6a4f" stroke-width="16" stroke-linecap="round" opacity="0.9"/>
  </g>
  <g transform="translate(372 136) scale(${scale})">
    <path d="M0 -58 L14 -14 L58 0 L14 14 L0 58 L-14 14 L-58 0 L-14 -14 Z" fill="#f4b740"/>
  </g>
</svg>`;
